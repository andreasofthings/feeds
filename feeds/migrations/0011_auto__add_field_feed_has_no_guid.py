...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Feed.has_no_guid'
        db.add_column(u'feeds_feed', 'has_no_guid',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Feed.has_no_guid'
        db.delete_column(u'feeds_feed', 'has_no_guid')
    ...
    models = {
        ...
        u'feeds.feed': {
            ...
            'announce_posts': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'has_no_guid': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
