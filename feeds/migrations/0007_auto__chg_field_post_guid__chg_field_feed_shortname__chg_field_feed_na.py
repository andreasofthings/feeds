...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'feeds_post', 'guid', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255))

        # Changing field 'Feed.shortname'
        db.alter_column(u'feeds_feed', 'shortname', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'Feed.name'
        db.alter_column(u'feeds_feed', 'name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'Post.guid'
        db.alter_column(u'feeds_post', 'guid', self.gf('django.db.models.fields.CharField')(max_length=200, unique=True))
        ...
        # User chose to not deal with backwards NULL issues for 'Feed.name'
        raise RuntimeError("Cannot reverse this migration. 'Feed.name' and its values cannot be restored.")
