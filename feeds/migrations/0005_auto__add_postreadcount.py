...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PostReadCount'
        db.create_table(u'feeds_postreadcount', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('post', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['feeds.Post'])),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'feeds', ['PostReadCount'])


    def backwards(self, orm):
        # Deleting model 'PostReadCount'
        db.delete_table(u'feeds_postreadcount')
