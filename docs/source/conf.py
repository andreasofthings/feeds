...
intersphinx_mapping = {
    ...
    'django':
        ('http://readthedocs.org/docs/django/en/latest/', None),
    'classytags':
        ('http://readthedocs.org/docs/django-classy-tags/en/latest/', None),
    'sekizai':
        ('http://readthedocs.org/docs/django-sekizai/en/latest/', None),
    'django-crispy-forms':
        ('https://django-crispy-forms.readthedocs.org/en/latest/', None),
}
